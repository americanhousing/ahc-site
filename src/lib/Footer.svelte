...
<div class={isInverted === true ? "bg-cumulus" : "bg-blue"}>
	<div
		class="font-die-a type-caption mx-auto flex h-[890px] max-h-[110svh] min-h-[400px] max-w-[1440px] flex-col overflow-hidden p-6 md:h-[70vh] md:max-h-[800px] md:min-h-[400px] {isInverted === true ? 'text-blue' : 'text-cumulus'}"
		...
		<img
			...
			src={isInverted === true ? "/images/american-housing-blue.svg" : "/images/american-housing.svg"}
			width="1385"
			height="180"
		...
		<img
			...
			class:translate-none={shouldElevateRoof}
			class:opacity-100={shouldElevateRoof}
			src={isInverted === true ? "/images/american-housing-alt-blue.svg" : "/images/american-housing-alt.svg"}
			width="355"
			height="172"
			alt="American Housing" />
		...
		<div
			...
			<div class="flex items-center gap-6">
				<img
					src={isInverted === true ? "/icons/social-linkedin-blue.svg" : "/icons/social-linkedin.svg"}
					width="18"
					height="18"
					alt="Linkedin" />
				<img
					src={isInverted === true ? "/icons/social-x-blue.svg" : "/icons/social-x.svg"}
					width="20"
					height="18"
					alt="X" />
				<img
					src={isInverted === true ? "/icons/social-instagram-blue.svg" : "/icons/social-instagram.svg"}
					width="18"
					height="18"
					alt="Instagram" />
			</div>
			<div class="flex-1"></div>
			<div
				class="font-die-a type-caption flex flex-col gap-6 md:flex-row md:gap-12 {isInverted === true ? 'text-blue' : 'text-cumulus'}">
			...
			<div
				class="hidden w-[250px] border-b-1 pb-0.5 md:flex {isInverted === true ? 'border-b-blue' : 'border-b-cumulus'}">
				<input
		...
		<div
			class="flex translate-y-12 border-b-1 pb-0.5 opacity-0 transition-all delay-400 duration-1500 ease-out md:hidden md:w-[250px] {isInverted === true ? 'border-b-blue' : 'border-b-cumulus'}"
		...
		<div
			...
			<div class="flex items-center gap-6">
				<img
					src={isInverted === true ? "/images/flag-blue.svg" : "/images/flag-cumulus.svg"}
					width="52"
					height="30"
					alt="" />
